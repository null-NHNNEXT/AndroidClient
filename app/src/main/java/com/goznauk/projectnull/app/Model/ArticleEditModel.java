...
public class ArticleEditModel extends BaseModel {
    ...
    public void fetch(final int postStatus, final String title, final String content){
        ...
        new SubmitArticleDetail(postStatus, title, content).executeForNewPost(new OnResponseListener() {
            @Override
    ...
    public void fetch(int postStatus, String articleId, String title, String content){
        ...
        new SubmitArticleDetail(postStatus, articleId, title, content).executeFormerPost(new OnResponseListener() {
            @Override
            public void onResponse(Response response) {
                try {
